    ...
    >
      <Fade bottom>
        ...
        <div className="flex-justify-sb">
          <p>
            <span className="icon icon-office"></span>
            {props.company}
          </p>
          <p>
        ...
        <Fade bottom>
          ...
          <div className="resumeTabs">
            <span className="icon icon-graduation-cap">
              <label
                onClick={(e) => this.filter(e, "education")}
            ...
            <span className="icon icon-stack">
              {" "}
              <label
                onClick={(e) => this.filter(e, "experience")}
                className="resumeSelector currentTab resumeTab"
              >
                Experience
              </label>
            </span>
          ...
          <div className="resumeCardWrapper container">
            ...
            <div className="resumeContainer">{edu}</div>
          </div>
        </Fade>
      </div>
    );
